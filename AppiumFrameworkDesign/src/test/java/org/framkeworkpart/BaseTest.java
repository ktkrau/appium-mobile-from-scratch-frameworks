...
public class BaseTest {
	...
	public void ConfigureAppium() throws MalformedURLException {
		service = new AppiumServiceBuilder().withAppiumJS(new File("C://Users//KatherineKraushaar//AppData//Roaming//npm//node_modules//appium//build//lib//main.js")).withIPAddress("127.0.0.1").usingPort(4723).build();
		service.start();
		
		UiAutomator2Options options = new UiAutomator2Options();
		options.setDeviceName("UdemyAppium");
		options.setChromedriverExecutable("C:\\Users\\KatherineKraushaar\\Documents\\chromedriver.exe");
		//options.setApp("C://eclipse-workspaces//appium-mobile//Appium//src//test//java//resources//ApiDemos-debug.apk");
		options.setApp("C://eclipse-workspaces//appium-mobile//Appium//src//test//java//resources//General-Store.apk");
